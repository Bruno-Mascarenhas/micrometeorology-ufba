...
def getLatLon(dataset,lat,lon,name):
    try:
        ...
        print("lat = {} long = {}".format(latCoord,longCoord))
        print("lat = {} long = {}".format(ncoord[0][0], ncoord[0][1]))
        print("lat = {} long = {}".format(matrix[16,38][0] ,matrix[16,38][1]))
        #print("lat = {} long = {}".format(matrix[15, 39][0], matrix[15, 39][1]))
        #print("lat = {} long = {}".format(matrix[16, 39][0], matrix[16, 39][1]))
        #print("lat = {} long = {}".format(matrix[16, 38][0], matrix[16, 38][1]))

        return latCoord+1, longCoord+1
